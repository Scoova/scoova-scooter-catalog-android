...
ARTIFACT_DIR="info/scoo-va/scoova-scooter-catalog-android"
...
ARTIFACT_NAME="${ARTIFACT_NAME:-scoova-scooter-catalog-android-$VERSION}"
...
if [[ "$HTTP_CODE" =~ ^2[0-9][0-9]$ ]]; then
  ...
  echo "Artifact will be queryable at: https://repo1.maven.org/maven2/info/scoo-va/scoova-scooter-catalog-android/$VERSION/"
  exit 0
fi
